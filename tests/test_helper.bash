# export BATS_LIB_PATH="${BATS_LIB_PATH:-}${BATS_LIB_PATH:+:}/usr/lib/bats"
...
# Use absolute path instead of relative: the tests in fixtures/ also load this
# file and break bats' search logic.
load /code/tests/git_helper.bash
